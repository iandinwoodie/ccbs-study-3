...
df_adj_dtypes <- df_adj_dtypes %>%
  mutate(dog_age_is_known = ifelse(dog_age_is_known == 'Yes', TRUE, FALSE)) %>%
  mutate(dog_was_acquired_pre_adolescent = ifelse(dog_was_acquired_pre_adolescent == 'True', TRUE, FALSE)) %>%
  ...
  mutate(dog_was_aggressive = ifelse(dog_was_aggressive == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_fear_or_anxiety = ifelse(dog_has_fear_or_anxiety == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_jumped_problematically = ifelse(dog_has_jumped_problematically == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_barked_excessively = ifelse(dog_has_barked_excessively == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_coprophagia = ifelse(dog_has_coprophagia == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_repetitive_behavior = ifelse(dog_has_repetitive_behavior == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_house_soiled = ifelse(dog_has_house_soiled == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_rolled_in_repulsive_material = ifelse(dog_has_rolled_in_repulsive_material == 'True', TRUE, FALSE)) %>%
  mutate(dog_was_hyperactive = ifelse(dog_was_hyperactive == 'True', TRUE, FALSE)) %>%
  mutate(dog_was_destructive = ifelse(dog_was_destructive == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_escaped = ifelse(dog_has_escaped == 'True', TRUE, FALSE)) %>%
  mutate(dog_has_mounted = ifelse(dog_has_mounted == 'True', TRUE, FALSE)) 
...
#remove duplicate columns (character columns that were replaced by factors)
df_adj_dtypes <- df_adj_dtypes %>%
