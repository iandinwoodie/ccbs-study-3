...
p <- ggplot(df_valid_responses, aes(x=as.character(num_behv_problems))) + geom_bar(fill='steelblue') + geom_text(aes(label = ..count..), stat = "count", vjust = 1.1, colour = "white")

p.labs <- p + labs(x = "Number of behavior problems")# , y = "Y-AXIS TITLE")
p.labs
