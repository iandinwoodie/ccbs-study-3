...
df_reward_only_training <- subset(df, reward_only_adult_training==TRUE | dog_adolescent_or_adult_training==FALSE)

nrow(subset(df_reward_only_training, reward_only_adult_training==TRUE))
nrow(subset(df_reward_only_training, dog_adolescent_or_adult_training==FALSE))
...
Looking at reward-only based training vs. no training (eliminating dogs that had received any discipline-based training):
605 responses in dataset
358 received reward-only training (experiment)
