...
for (outcome in outcomes) {
  ...
  df_tmp <- df_all_preK_training[,c(outcome, pred)]
...
```{r}
#only choose outcomes that were significant?
outcomes_sig <- c(
  'dog_was_aggressive',
  'dog_has_fear_or_anxiety',
  'dog_has_jumped_problematically',
