...
#df_control <- readRDS('../data/df_control_no_adult_training.Rds')
dim(df_control)
...
df_exp_reward <- readRDS('../data/df_exp_reward.Rds')
dim(df_exp_reward)
...
df_preK_training <- rbind(df_control_puppy_training_only,df_exp_puppy_and_adult_training)
df_no_preK_training <- rbind(df_adult_only,df_no_training)
nrow(df_preK_training) + nrow(df_no_preK_training)

df_combo_preK <- rbind(df_preK_training,df_no_preK_training)

df_combo_reward <- rbind(df_control, df_exp_reward)
